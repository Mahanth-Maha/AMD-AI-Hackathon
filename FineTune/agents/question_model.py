...
class QAgent(object):
    def __init__(self, **kwargs):
        ...
        base_model_path = kwargs.get('base_model_path', "/jupyter-tutorial/hf_models/Qwen3-4B")
        finetuned_model_path = kwargs.get('finetuned_model_path', None)
        ...
        # Load model: use finetuned path if provided, else base model
        model_load_path = finetuned_model_path if finetuned_model_path else base_model_path
