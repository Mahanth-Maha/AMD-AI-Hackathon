...
# ====== USER CONFIGURATION ======
REPO_NAME="AMD-AI-Hackathon"      # <-- Change this to actual IP
VISIBILITY="public"                    # or "private"
COMMIT_MESSAGE="pusing from jupyter-tutorial"
GITHUB_USERNAME="mahanth-maha"        # <-- Change this
GITHUB_EMAIL="mahanthyalla@iisc.ac.in"         # <-- Change this
# =================================
